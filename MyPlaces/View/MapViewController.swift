...
class MapViewController: UIViewController {
    ...
    @IBOutlet var centerViewInUserLocationButton: UIButton!
    ...
    override func viewDidLoad() {
        ...
        centerViewInUserLocationButton.alpha = 0.6
        mapPinImage.alpha = 0.65
        goButton.alpha = 0.65
    ...
    private func getDirections() {
        ...
        directions.calculate { (response, error) in
            ...
            for route in response.routes {
                ...
                //FIXME: Add Label on MapView Screen
                print("Distance: \(distance)")
                print("Time: \(timeInterval) сек")
            }
        }
    }
